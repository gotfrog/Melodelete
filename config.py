...
class Config:
    ...
    def set_channel(self, channel_id: int, time_threshold: Optional[int], max_messages: Optional[int],usesCrazy6Rules:Optional[bool]) -> None:
